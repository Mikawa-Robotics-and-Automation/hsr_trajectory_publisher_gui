...
class ArmTrajectoryPanel : public rviz_common::Panel
{
    Q_OBJECT
public:
    ArmTrajectoryPanel(QWidget *parent = nullptr);
...
protected:
    ...
    QLabel* image_label_;
    QSlider* arm_lift_slider_;
    QSlider* arm_flex_slider_;
    QSlider* arm_roll_slider_;
    QSlider* wrist_flex_slider_;
    QSlider* wrist_roll_slider_;
};
